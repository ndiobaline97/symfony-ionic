 ...
 */
final class Version20190909092707 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_47948BBCA4AEAFEA ON depot');
        $this->addSql('ALTER TABLE depot ADD compte_id INT DEFAULT NULL, DROP entreprise_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE depot ADD entreprise_id INT NOT NULL, DROP compte_id');
        $this->addSql('ALTER TABLE depot ADD CONSTRAINT FK_47948BBCA4AEAFEA FOREIGN KEY (entreprise_id) REFERENCES entreprise (id)');
        $this->addSql('CREATE INDEX IDX_47948BBCA4AEAFEA ON depot (entreprise_id)');
    }
}
