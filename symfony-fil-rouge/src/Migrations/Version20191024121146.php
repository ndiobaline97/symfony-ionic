 ...
 */
final class Version20191024121146 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, entreprise_id INT NOT NULL, profil_id INT DEFAULT NULL, compte_id INT DEFAULT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, telephone INT NOT NULL, nci VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, image_name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_1D1C63B3F85E0677 (username), UNIQUE INDEX UNIQ_1D1C63B3450FF010 (telephone), UNIQUE INDEX UNIQ_1D1C63B3C7B6DEA0 (nci), INDEX IDX_1D1C63B3A4AEAFEA (entreprise_id), INDEX IDX_1D1C63B3275ED078 (profil_id), INDEX IDX_1D1C63B3F2C56620 (compte_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tarif (id INT AUTO_INCREMENT NOT NULL, borne_inferieure INT NOT NULL, borne_superieure INT NOT NULL, valeur INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE compte (id INT AUTO_INCREMENT NOT NULL, entreprise_id INT NOT NULL, solde VARCHAR(255) NOT NULL, no_compte VARCHAR(255) NOT NULL, INDEX IDX_CFF65260A4AEAFEA (entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE entreprise (id INT AUTO_INCREMENT NOT NULL, raison_sociale VARCHAR(255) NOT NULL, ninea VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_D19FA60C678AEBE (ninea), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE transaction (id INT AUTO_INCREMENT NOT NULL, user_emetteur_id INT DEFAULT NULL, user_recepteur_id INT DEFAULT NULL, client_emetteur VARCHAR(255) NOT NULL, telephone_emetteur VARCHAR(255) NOT NULL, nci_emetteur VARCHAR(255) NOT NULL, date_envoi DATETIME NOT NULL, code VARCHAR(255) NOT NULL, montant BIGINT NOT NULL, frais BIGINT NOT NULL, client_recepteur VARCHAR(255) NOT NULL, telephone_recepteur VARCHAR(255) NOT NULL, nci_recepteur VARCHAR(255) DEFAULT NULL, date_reception DATETIME DEFAULT NULL, commission_emetteur BIGINT DEFAULT NULL, commission_recepteur BIGINT DEFAULT NULL, commission_wari BIGINT DEFAULT NULL, taxes_etat BIGINT DEFAULT NULL, etat VARCHAR(255) NOT NULL, INDEX IDX_723705D1D0F2E719 (user_emetteur_id), INDEX IDX_723705D1BB85042F (user_recepteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
