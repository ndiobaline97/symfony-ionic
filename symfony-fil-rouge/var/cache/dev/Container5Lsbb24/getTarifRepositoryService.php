...
// Returns the private 'App\Repository\TarifRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TarifRepository.php';

return $this->privates['App\\Repository\\TarifRepository'] = new \App\Repository\TarifRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
