...
class Compte extends \App\Entity\Compte implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'solde', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'entreprise', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'noCompte', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'depots'];
        }
     ...
     * {@inheritDoc}
     */
    public function setEntreprise(?\App\Entity\Entreprise $entreprise): \App\Entity\Compte
    {
    ...
    public function getNoCompte(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNoCompte', []);

        return parent::getNoCompte();
    }

    /**
     * {@inheritDoc}
     */
    public function setNoCompte(string $noCompte): \App\Entity\Compte
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNoCompte', [$noCompte]);

        return parent::setNoCompte($noCompte);
    }
